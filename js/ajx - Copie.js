...
var thankyou="<p><i class='fa fa-check'></i> ENREGISTREMENT VALIDE</p>";  
...
function emptyvalidation(entered, errorMessage) {
	...
	with (entered) {
	if (trim(value)==null || trim(value)=="" || trim(value)=="ENTREZ VOTRE NOM") {/*alert(errorMessage);*/$Npro("Error").innerHTML=errorMessage;$Npro("Error").style.display="inline";return false;}
